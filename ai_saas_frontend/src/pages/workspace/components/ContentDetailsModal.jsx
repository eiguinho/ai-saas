    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-brightness-50">
      <div className="bg-white rounded-lg p-9 w-full max-w-md shadow-lg relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="text-sm text-gray-700 space-y-2 mb-6">
          ...
          <p><strong>Modelo:</strong> {content.model_used || "—"}</p>
        ...
        {showAddButton && (
          <button onClick={onAdd} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-md font-semibold transition" aria-label="Adicionar conteúdo ao projeto">
